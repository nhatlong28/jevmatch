...
- Render, add, edit, delete, and reorder questions.
- Change importance and switch Score/Noul.
- Edit ordered Score criteria and display fixed importance weights.
...
- IDs remain stable and are not directly editable.
